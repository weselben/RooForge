...
| [`skills/forge-eu-accessibility/SKILL.md`](skills/forge-eu-accessibility/SKILL.md) | EU accessibility compliance — BFSG/EAA scope, WCAG 2.1 AA baseline, penalties, live verification | on-demand | [local](https://raw.githubusercontent.com/weselben/RooForge/main/skills/forge-eu-accessibility/SKILL.md) | [`docs/guides/forge-eu-accessibility.md`](docs/guides/forge-eu-accessibility.md) |
| [`skills/forge-seo/SKILL.md`](skills/forge-seo/SKILL.md) | SEO hub — UX/UI and Technical deep-dives (Core Web Vitals, sitemaps, structured data, rendering) | on-demand | [local](https://raw.githubusercontent.com/weselben/RooForge/main/skills/forge-seo/SKILL.md) | [`docs/guides/forge-seo.md`](docs/guides/forge-seo.md) |
